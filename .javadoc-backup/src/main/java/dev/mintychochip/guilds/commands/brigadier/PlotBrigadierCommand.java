...
import dev.mintychochip.guilds.commands.arguments.PlotTypeArgumentType;
import dev.mintychochip.guilds.commands.arguments.ResidentArgumentType;
import dev.mintychochip.guilds.commands.arguments.RoleArgumentType;
...
public class PlotBrigadierCommand {
    ...
    /**
     * Creates a new plot brigadier command instance.
    ...
    /**
     * Performs the show perm help operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the show type help operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the display plot info operation.
    ...
    /**
     * Performs the display plot permissions operation.
     * @param player the player
     * @param plot the plot
     * @param specificRole the specific role
     */
     ...
     * @param currentFlags the current flags
     * @param role the role
