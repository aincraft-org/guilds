...
class BukkitEconomyBridgeTest {
    ...
    private static final class CapturingBridge extends EconomyBridge {
        ...
        CapturingBridge() {
            super(new org.aincraft.guilds.territory.registry.TerritoryRegistry(),
                    new org.aincraft.guilds.territory.permission.GovernanceRegistry(
                            new org.aincraft.guilds.territory.registry.TerritoryRegistry()),
                    org.aincraft.guilds.territory.decree.GoodsCatalog.defaultCatalog(),
