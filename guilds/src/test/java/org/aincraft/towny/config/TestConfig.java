...
public class TestConfig {
    ...
    public static TestConfig load() {
        ...
        try (InputStream input = TestConfig.class.getClassLoader()
            ...
            db.setUrl(properties.getProperty("test.datasource.url", "jdbc:h2:mem:towny_test;DB_CLOSE_DELAY=-1;MODE=MySQL"));
            ...
            plugin.setName(properties.getProperty("test.plugin.name", "Towny"));
            ...
            plugin.setDatabasePrefix(properties.getProperty("test.plugin.database-prefix", "towny_test_"));
    ...
    public static class DatabaseConfig {
        ...
        private String url = "jdbc:h2:mem:towny_test;DB_CLOSE_DELAY=-1;MODE=MySQL";
    ...
    public static class PluginConfig {
        ...
        private String databasePrefix = "towny_test_";
    ...
    public static class LoggingConfig {
        ...
        private String levelAincraftTowny = "DEBUG";
        ...
        public String getLevelAincraftTowny() { return levelAincraftTowny; }
        public void setLevelAincraftTowny(String levelAincraftTowny) { this.levelAincraftTowny = levelAincraftTowny; }
