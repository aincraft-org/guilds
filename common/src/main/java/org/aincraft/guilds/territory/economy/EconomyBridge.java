...
import org.aincraft.guilds.territory.decree.DecreeEffectsInterpreter;
...
import org.aincraft.guilds.territory.economy.AsyncSettlementResult;
import java.util.function.Consumer;
/**
 * Public transaction API: other plugins report sales here; Guilds applies PASSED
...
public class EconomyBridge {
    ...
    public CompletionStage<TaxReport> reportSaleAsync(
        ...
        double taxAmount = TaxCalculator.tax(grossAmount, rate);
        String guildId = body.guildBody().map(org.aincraft.guilds.territory.permission.GuildBody::id).orElse(null);
