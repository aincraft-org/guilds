...
/**
 * Represents a player (resident) in the Towny system
 */
public class  Resident {
    ...
    public boolean isMayor() {
        ...
        return hasPermission("towny.mayor");
    }
    ...
    public boolean isAssistant() {
        return hasPermission("towny.assistant");
    }
    ...
    public void leaveTown() {
        ...
        permissions.remove("towny.mayor");
        permissions.remove("towny.assistant");
    }
