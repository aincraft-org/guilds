...
public final class GovernanceRegistry {
     ...
     */
    public Optional<Guild> primaryGuildForMember(String holderId) {
        List<Guild> list = source.guildsForMember(holderId);
     ...
     */
    public Optional<Guild> governingGuildForTerritory(String territoryId) {
     ...
     */
    public Optional<Guild> governingGuildAt(String worldId, int blockX, int blockZ) {
    ...
    public GoverningBody resolveForTerritory(String territoryId) {
        Optional<Guild> guild = governingGuildForTerritory(territoryId);
        if (guild.isPresent()) {
            Optional<Alliance> alliance = source.allianceContainingGuild(guild.get().id());
    ...
    public Policy castPolicyVote(
            ...
            String policyId,
            String voterId,
            dev.mintychochip.territory.model.VoteChoice choice,
            long nowEpochMs
    ) {
        Territory t = requireTerritory(territoryId);
