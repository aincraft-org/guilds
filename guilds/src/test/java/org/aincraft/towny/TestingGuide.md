# Towny Plugin Testing Guide

This guide provides comprehensive information about testing the Towny Bukkit plugin using modern testing practices with MockBukkit, JUnit 5, and Mockito.
...
The Towny testing suite is designed with the following principles:
...
./gradlew test --tests "org.aincraft.towny.models.TownBlockTest"
...
This testing guide provides a comprehensive framework for testing all aspects of your Towny plugin, from individual model methods to complex command interactions.
