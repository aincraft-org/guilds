...
/**
 * Brigadier implementation of the towny general command
 */
public class TownyGeneralBrigadierCommand {
    ...
    @Inject
    public TownyGeneralBrigadierCommand(TownyPlugin plugin, ResidentService residentService,
    ...
    public LiteralCommandNode<CommandSourceStack> buildCommand() {
        return Commands.literal("towny")
            .requires(source -> source.getSender().hasPermission("towny.general"))
            .executes(this::showHelp)
            // Version subcommand
            .then(Commands.literal("version")
                .requires(source -> source.getSender().hasPermission("towny.general.version"))
                .executes(this::handleVersion))
            // Time subcommand
            .then(Commands.literal("time")
                .requires(source -> source.getSender().hasPermission("towny.general.time"))
                .executes(this::handleTime))
            // Top subcommand
            .then(Commands.literal("top")
                .requires(source -> source.getSender().hasPermission("towny.general.top"))
            ...
            .then(Commands.literal("prices")
                .requires(source -> source.getSender().hasPermission("towny.general.prices"))
                .executes(this::handlePrices))
            // Chat subcommand
            .then(Commands.literal("chat")
                .requires(source -> source.getSender().hasPermission("towny.general.chat"))
            ...
            .then(Commands.literal("universe")
                .requires(source -> source.getSender().hasPermission("towny.general.universe"))
    ...
    private int showHelp(CommandContext<CommandSourceStack> ctx) {
        ...
        sender.sendMessage("§6║           §e§lTOWNY GENERAL COMMANDS§r§6          ║");
        sender.sendMessage("§6╠══════════════════════════════════════════════╣");
        sender.sendMessage("§6║ §f/towny version§7                               §6║");
        sender.sendMessage("§6║   §8» Show plugin version                    §6║");
        sender.sendMessage("§6║                                                §6║");
        sender.sendMessage("§6║ §f/towny time§7                                 §6║");
        sender.sendMessage("§6║   §8» Show current server time                §6║");
        sender.sendMessage("§6║                                                §6║");
        sender.sendMessage("§6║ §f/towny top§7                                 §6║");
        sender.sendMessage("§6║   §8» Show top statistics                     §6║");
        sender.sendMessage("§6║                                                §6║");
        sender.sendMessage("§6║ §f/towny prices§7                              §6║");
        sender.sendMessage("§6║   §8» Show town and plot costs                §6║");
        sender.sendMessage("§6║                                                ║");
        sender.sendMessage("§6║ §f/towny chat§7                                §6║");
        sender.sendMessage("§6║   §8» Send message to town chat               §6║");
        sender.sendMessage("§6║                                                ║");
        sender.sendMessage("§6║ §f/towny universe§7                            §6║");
    ...
    private int handleVersion(CommandContext<CommandSourceStack> ctx) {
        var sender = ctx.getSource().getSender();
        sender.sendMessage("§6=== Towny Plugin Information ===");
    ...
    private int showTopHelp(CommandContext<CommandSourceStack> ctx) {
        ...
        sender.sendMessage("§f/towny top residents§7 - Top residents by town count");
        sender.sendMessage("§f/towny top towns§7 - Top towns by resident count");
        sender.sendMessage("§f/towny top land§7 - Top towns by land count");
        return Command.SINGLE_SUCCESS;
    }
    ...
    private int handlePrices(CommandContext<CommandSourceStack> ctx) {
        var sender = ctx.getSource().getSender();
        sender.sendMessage("§6=== Towny Prices ===");
    ...
    private int handleChatHelp(CommandContext<CommandSourceStack> ctx) {
        ...
        sender.sendMessage("§f/towny chat <message>§7 - Send message to town chat");
        sender.sendMessage("§f/towny chat tc <message>§7 - Alias for town chat");
