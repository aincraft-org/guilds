...
import org.aincraft.guilds.territory.model.PolicyRules;
...
public final class GovernanceRegistry {
    ...
    public Policy proposePolicy(
        ...
        return proposePolicy(territoryId, policyId, title, body, proposerId, nowEpochMs,
                org.aincraft.guilds.territory.decree.DecreeEffects.empty());
    }
    ...
    public Policy proposePolicy(
            ...
            String proposerId,
            long nowEpochMs,
            org.aincraft.guilds.territory.decree.DecreeEffects effects
    ) {
    ...
    public Policy castPolicyVote(
            ...
            String policyId,
            String voterId,
            org.aincraft.guilds.territory.model.VoteChoice choice,
            long nowEpochMs
    ) {
        Territory t = requireTerritory(territoryId);
