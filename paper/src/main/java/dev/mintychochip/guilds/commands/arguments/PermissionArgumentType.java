...
public class PermissionArgumentType implements CustomArgumentType<String, String> {
    ...
    /** The invalid permission constant. */
    ...
    /** Creates a new permission argument type instance. */
    private PermissionArgumentType() {}

    /**
     * Performs the permission operation.
     * @return the result
     */
    ...
    /**
     * Returns whether valid permission.
