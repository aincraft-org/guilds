...
| **Persistence** | [persistence.md](./persistence.md) | Unified SQL (PostgreSQL default, MySQL selectable), shared pool, stores |
...
3. **SQL-only** durable state (PostgreSQL default, MySQL selectable): see [persistence.md](./persistence.md).
