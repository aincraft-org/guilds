 ...
 * <p>
 * The guilds subsystem models guilds as towns in the original schema; objects
 * kept the old "town" vocabulary. Fresh installs now create {@code guild*}
 * names directly (migrations v1–v15 use the new names), so this migration
 * no-ops on them. Existing databases (created before v16) get their tables,
 * columns, and indexes renamed in place, preserving all rows.
 * <p>
