package dev.mintychochip.boundary;
...
public final class GoverningBody {
     ...
     */
    public static GoverningBody ofAlliance(Alliance alliance) {
     ...
     */
    public static GoverningBody ofGuild(Guild guild) {
     ...
     */
    public Optional<Guild> guildBody() {
     ...
     */
    public Optional<Alliance> allianceBody() {
