...
public class PermissionMigration {
    ...
    public static class MigrationStats {
        ...
        /**
         * Creates a new migration stats instance.
         * @param totalPermissions the total permissions
         * @param legacyFlags the legacy flags
         * @param enumConverted the enum converted
         * @param missingEnum the missing enum
         */
