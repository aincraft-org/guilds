...
public class PlotBrigadierCommand {
    ...
    public LiteralCommandNode<CommandSourceStack> buildCommand() {
        return Commands.literal("plot")
            .requires(source -> source.getSender().hasPermission("towny.plot"))
            .executes(this::showHelp)
            // Claim subcommand
            .then(Commands.literal("claim")
                .requires(source -> source.getSender().hasPermission("towny.plot.claim"))
                .executes(this::handleClaim))
            // Unclaim subcommand
            .then(Commands.literal("unclaim")
                .requires(source -> source.getSender().hasPermission("towny.plot.unclaim"))
                .executes(this::handleUnclaim))
            // Info subcommand
            .then(Commands.literal("info")
                .requires(source -> source.getSender().hasPermission("towny.plot.info"))
                .executes(this::handleInfo))
            // ForSale subcommand
            .then(Commands.literal("forsale")
                .requires(source -> source.getSender().hasPermission("towny.plot.forsale"))
            ...
            .then(Commands.literal("buy")
                .requires(source -> source.getSender().hasPermission("towny.plot.buy"))
                .executes(this::handleBuy))
            // Permission subcommand
            .then(Commands.literal("perm")
                .requires(source -> source.getSender().hasPermission("towny.plot.perm"))
            ...
            // List subcommand
            .then(Commands.literal("list")
                .requires(source -> source.getSender().hasPermission("towny.plot.list"))
