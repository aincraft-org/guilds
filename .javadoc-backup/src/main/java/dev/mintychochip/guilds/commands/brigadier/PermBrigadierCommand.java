...
import dev.mintychochip.guilds.commands.arguments.PermissionArgumentType;
...
public class PermBrigadierCommand {
    ...
    /**
     * Creates a new perm brigadier command instance.
    ...
    /**
     * Performs the show usage operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the test build permission operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the test destroy permission operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the test plot permission default operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the test plot permission operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the test guild permission operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the show permission flags operation.
     * @param ctx the ctx
     * @return the result
     */
    ...
    /**
     * Performs the show location info operation.
     * @param ctx the ctx
     * @return the result
     */
