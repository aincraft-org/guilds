...
public interface GuildLevelService {
    ...
    /**
     * Applies every level the guild can currently afford from leftover XP.
     *
     * @param guild guild to advance
     * @return applied upgrades, empty when no level changed
     */
    java.util.List<UpgradeResult> applyReadyLevels(Guild guild);
